...
#  Default: '/opt/hub/env/share/jupyterhub'
# c.JupyterHub.data_files_path = '/opt/hub/env/share/jupyterhub'
...
c.Spawner.cmd = ['/opt/hub/env/bin/jupyterhub-singleuser']
...
#  Default: set()
c.Authenticator.admin_users = ['zac', 'zacchance']
